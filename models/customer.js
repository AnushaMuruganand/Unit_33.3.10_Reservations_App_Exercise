...
class Customer {
  constructor({ id, firstName, lastName, phone, notes }) {
   ...
   /** methods for getting/setting notes (keep as empty string, not NULL) which can be accessed as a PROPERTY */
  ...
  /** methods for getting/setting phone #, which can be accessed as a PROPERTY  */
  ...
  /** top 10 customers with maximum reservations */
  static async top() {
    const results = await db.query(
      `
